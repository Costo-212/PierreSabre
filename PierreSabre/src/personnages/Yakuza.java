...
public class Yakuza extends Humain{
	...
	public void extorquer(Commercant victime) {
		réputation+=1;
		parler("Tiens, tiens, ne serait-ce pas un faible marchand qui passe par là ?(bully)");
	...
	public int perdre() {
		int temp = getArgent();
		this.réputation-=1;
		parler("j'ai perdu mon duel et mes "+ temp + " sous, snif... J'ai déshonoré l'emblême du clan de"+ clan);
		perdreArgent(temp);
		return temp;
	}
	//gagner la duel
